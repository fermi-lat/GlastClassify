...

{
    ...
    declareProperty("xmlFileName",   m_xmlFileName="$(GLASTCLASSIFYXMLPATH)/Pass7_Analysis_Protected.xml"); // For processing with TMine
    //declareProperty("xmlFileName",   m_xmlFileName="");  // For proccessing with GlastClassify
